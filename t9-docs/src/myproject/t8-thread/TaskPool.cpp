...
/**
\brief
 Слияние для сортировки без использования этих ваших тредов
\date 2018-12-14
\param[in] xf первый элемент первого куска для слияния
\param[in] xf второй элемент первого куска для слияния
\param[in] xf первый элемент второго куска для слияния
\param[in] xf второй элемент второго куска для слияния
*/
template<typename T>
...
/**
\brief
 Супер класс внутри которого крутятся треды
\date 2018-12-14
*/
template<class T>
...
Конструктор
\date 2018-12-14
\param[in] first первый элемент того что будем сортировать
\param[in] last последний элемент того что будем сортировать
*/
...
/**
\brief
 Слияние для сортировки с использованием этих ваших тредов
\date 2018-12-14
\param[in] xf первый элемент первого куска для слияния
\param[in] xf второй элемент первого куска для слияния
\param[in] xf первый элемент второго куска для слияния
